...
//
 /// Graphics Code for Homework 6.

 /// DO NOT MODIFY THIS FILE.
 //
 //  If you'd like to modify something in this file, ask the
 //  instructor, and then copy it in to hw06.cc.
...
const char* const vtx_method_str[] = 
  { "render_sprial1: FIXED FUNCTIONALITY",
    "render_spiral2: GEOMETRY SHADER 2x WASTE",
    "render_spiral3: SOLUTION GEOMETRY PROBLEM 1" };
...
World::render_objects(Render_Option option)
{
  ...
  if ( option == RO_Shadow_Volumes )
  ...
  else
    {
      ...
      case 0: render_spiral1(); break;
      case 1: render_spiral2(); break;
      case 2: render_spiral3(); break;
...
# define BLINK(txt,pad) ( blink_visible ? txt : pad )
  ...
  ogl_helper.fbprintf
    ("debug_bool.x %s ('d' to change)  debug_bool.y %s ('D' to change)\n",
     opt_debug_x ? "TRUE" : "FALSE",
     opt_debug_y ? "TRUE" : "FALSE");
...
World::cb_keyboard()
{
  ...
  case 'd': opt_debug_x = !opt_debug_x; break;
  case 'D': opt_debug_y = !opt_debug_y; break;
  ...
  case 'm': case 'M': 
    opt_vtx_method++;
    if ( opt_vtx_method == 3 ) opt_vtx_method = 1;
    break;
