...
//
 ...
 /// DO NOT PUT THE SOLUTION TO HOMEWORK 5 HERE.
 //  Instead, edit hw05-shdr-links.cc.
...
World::init(int argc, char **argv)
{
  ...
  sp_phong = new pShader
    ("hw05-shdr.cc",// File holding shader program.
  ...
  sp_set_1 = new pShader
    (links_shader_code_path,
     ...
     "fs_main_1();"       // Name of fragment shader main routine.
     );
  sp_set_2 = new pShader
    (links_shader_code_path,
     "vs_main(); ",     // Name of vertex shader main routine.
     "gs_main_2();",      // Name of geometry shader main routine.
     "fs_main_2();"       // Name of fragment shader main routine.
     );
