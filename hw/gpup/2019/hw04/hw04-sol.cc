...
//
 ...
 /// Instructions
 //
 //  Read the assignment: https://www.ece.lsu.edu/koppel/gpup/2019/hw04.pdf
 //
 //  Put the solution in this file and in hw04-shdr.cc.
 //  In this file modify routine render_cylinder.
 //
 //  This file and hw04-shdr.cc will be collected.
