...
//
 /// Graphics Code for Homework 4

 /// DO NOT MODIFY THIS FILE.
 //
 //  If you'd like to modify something in this file, ask the
 //  instructor, and then copy it in to hw04.cc.
...
const char* const vtx_method_str[] = 
  { "Method 0: render_sprial1: FIXED FUNCTIONALITY",
    "Method 1: render_spiral2: SIMPLE GEOMETRY SHADER (PROBLEM 1)",
    "Method 2: render_spiral2: SOLUTION GEOMETRY SHADER (PROBLEM 2)"};
