...
public:
  ...
  void run_sort(int block_lg, int wp_per_mp_limit, int sort_radix_lg, bool sol)
  {
    ...
    Kernel_Info* const ki1 =
      sort_launch_pass_1(&gpu_info,0,block_size,sort_radix_lg, -1, false, sol );
    Kernel_Info* const ki2 =
      sort_launch_pass_2(&gpu_info,0,block_size,sort_radix_lg, -1, false, sol );
