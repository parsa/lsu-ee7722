...
//
//  This assignment is at SVN URI https://svn.ece.lsu.edu/svn/gp/hw/hw1
//
  ...
  for ( int i = 0; i < tile_count; i++ )
    {
      ...
      pNorm norm0( platform_xrad * cos(theta0), platform_xrad*sin(theta0), 0);
      pNorm norm1( platform_xrad * cos(theta1), platform_xrad*sin(theta1), 0);
