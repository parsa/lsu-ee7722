...
//
 ...
 /// Homework 1 Template, based on demo-1d-objects
 //
 // See http://www.ece.lsu.edu/koppel/gpup/2011/hw01.pdf for instructions.
...
#include "hw1-graphics.cc"
 ...
 /// Homework 1 - Declare routines, such as new_chair, here.
...
World::init()
{
  ...
  /// For Homework 1
  //
  //  These textures can be used in the homework 1 solution. If
  //  desired, change file names to point to an image to use for
  //  textures. Many formats supported, including jpeg and png.
  //
  ...
  /// Homework 1 Solution Starts Here - Code instantiating chair, etc.

}


 /// Homework 1 Solution Here - New Routines
 //
 //  Put new_chair and other routines here, and declare them above.
 //  Use new_prism and new_tower as an example.
...
World::time_step_cpu_v0(double delta_t)
{
  ...
  /// Homework 1 - Account for air viscosity.
