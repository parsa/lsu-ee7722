...
//
//  This assignment is at SVN URI https://svn.ece.lsu.edu/svn/gp/hw/2009/hw6
//
//  The assignment instructions are in file hw6.cc. (This file.)
...
/// Overview
 ...
 // The code is not fully commented and there are some parts which
 // are partly written.
...
///  Keyboard Commands
 ...
 //  VAR Temperature - Temperature of gas.
 //  VAR Damping Factor - Ad-hoc damping. Higher is LESS damping.
 //  VAR Air Resistance -
...
/// Problem 0
 ...
 // Compile and run the code.  For better response run the optimized
 // (not debug) version.

 // [ ] Should see ball bouncing.
 // [ ] Adjust variables so balloon floats up and away.
 // [ ] Reduce gas amount until non-spherical, then slowly push off edge.
 // [ ] Stop playing and get to next problem.


/// Problem 1

 // A shadow is visible when the viewer is above the platform and the
 // balloon is below it. (To see it press pause, then move balloon
 // below platform.)  Fix this and similar shadow problems.

 // [ ] Fix shadow problems.
 // [ ] Avoid unnecessary changes and reformatting.


/// Problem 2

 // A reflection is visible when the viewer is above the platform and
 // the balloon is below it, or vice versa. (To see it press pause,
 // then move balloon below platform.) Fix this and similar reflection
 // problems.

 // [ ] Fix reflection problems.
 // [ ] Avoid unnecessary changes and reformatting.
